...
import MoneyStreamTypes from "modules/money_streams/types";
import {setSyncedMoneyStreams} from "modules/money_streams/actions";
import {getSyncedMoneyStreams} from "modules/money_streams/selectors";
...
export const syncConfigs: Array<SyncConfig<any>> = [
    ...
    },
    {
        ...
        version: 1,
        encrypted: false,
        selector: getSyncedMoneyStreams,
        action: setSyncedMoneyStreams,
        triggerActions: [
            MoneyStreamTypes.CREATE_MONEY_STREAM,
            MoneyStreamTypes.UPDATE_MONEY_STREAM,
            MoneyStreamTypes.DELETE_MONEY_STREAM,
        ],
    },
];
